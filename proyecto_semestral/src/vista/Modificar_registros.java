        ...
        if(tipo_registro.equalsIgnoreCase("persona")){
            ...
            if(tipo_persona.equals("Usuario")){
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "Usuario actualizado", "Validación", 1);
                }catch(Exception e){
                ...
                try{
                    if(tipo_persona.equals("Vendedor")){
                        Visualizador.sistema.actualizarVendedor(posicion_registro, fono, nombre, direccion, contraseña);
                    }else{
                        Visualizador.sistema.actualizarDesarrollador(posicion_registro, fono, nombre, direccion);
                    }
                    JOptionPane.showMessageDialog(null, tipo_persona+" actualizado", "Validación", 1);
                }catch(Exception e){
                    JOptionPane.showMessageDialog(null, e.getMessage(), "Validación", 1);
                }
            }
            ...
            try{
                Visualizador.sistema.actualizarVideoJuego(posicion_registro, nombre, version, fechaD, categoria, genero, precio);
                JOptionPane.showMessageDialog(null, tipo_registro+" actualizado", "Validación", 1);
            }catch(Exception e){
                JOptionPane.showMessageDialog(null, e.getMessage(), "Validación", 1);
            }
        }else{
